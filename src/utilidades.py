"""
Utilidades transversales: limpieza de texto, filtrado por tema y un logger
seguro para entornos multihilo.
"""
...
def contiene_alguna(texto: str, palabras: list[str]) -> bool:
    """True si el texto (en minúsculas) contiene alguna de las palabras."""
    t = texto.lower()
